...
const BookingModal: React.FC<BookingModalProps> = ({ 
  ...
  return (
    <div className="relative">
      ...
      {/* Received By Modal */}
      <Modal isOpen={showReceivedByModal} onClose={() => setShowReceivedByModal(false)} title="Slip Authorization" variant="dark">
        <div className="space-y-6">
          <div className="space-y-2">
            <label className={labelClasses}>Received By Name/Rank</label>
            <div className="relative group">
      ...
      <Modal isOpen={isConfirmingDelete} onClose={() => setIsConfirmingDelete(false)} title="Confirm Deletion" variant="dark">
