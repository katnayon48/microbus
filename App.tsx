  ...
  return (
    <>
      ...
      <div className={`flex flex-col bg-slate-100 text-slate-900 font-inter h-[100dvh] overflow-hidden transition-all duration-500 ${isLoading ? 'opacity-0' : 'opacity-100'}`}>
        ...
        <footer className="px-4 py-1.5 md:py-2 border-t border-slate-200 bg-white flex items-center justify-center text-[7px] md:text-[9px] text-black font-black uppercase tracking-[0.2em] shrink-0">
          <span>DEVELOPED BY 1815124 CPL (CLK) BILLAL</span>
        </footer>
