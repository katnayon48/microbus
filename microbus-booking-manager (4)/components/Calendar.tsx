...
import { ChevronLeft, ChevronRight, Calendar as CalendarIcon, Plus, ChevronDown, CalendarDays, LogIn, Search } from 'lucide-react';
      ...
      <div className="grid grid-cols-3 items-center px-3 md:px-6 py-1.5 md:py-2 border-b border-slate-200 bg-slate-50/50 shrink-0 gap-1 md:gap-2">
        ...
        <div className="flex justify-end items-center gap-1 md:gap-3">
          <button 
            ...
            className="flex items-center gap-1 md:gap-2 px-2 md:px-4 py-1 md:py-2.5 bg-indigo-50 text-indigo-700 border border-indigo-100 rounded-lg md:rounded-xl text-[7px] md:text-[10px] font-black uppercase tracking-widest hover:bg-indigo-600 hover:text-white shadow-sm active:scale-95 transition-all whitespace-nowrap"
          >
            <CalendarDays size={10} className="md:w-4 md:h-4 shrink-0" />
            <span>Jump To</span>
          </button>
